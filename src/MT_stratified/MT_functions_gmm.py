...
def update_gamma0( betahats, Omega_0, Omega_1, Cov_eL, pi_0, pi_1, K):
    ...
    denoms[denoms < 1e-20] = 1e-20 # TODO  currently set a small value to avoid divide by zero. need to figure out better way to avoid it/if it means model is bad, or if it's a snp that fits poorly for both models
...
def estimatePi(betahats, Omega_0, Omega_1, Cov_eL, K, M):
    maxIter = 1000 #TODO
    pi_0_est = 0.5 # TODO just start at 0.5
    pi_1_est = 1 - pi_0_est
