...
parser.add_argument('--gcov', required=True, help='File containing genetic covariance from LDSC results')
parser.add_argument('--h2', required=True, help='File containing estimation error covariance from LDSC results')
...
try:
    run_MTAG_MT(exptName, traitL, gwasNamesL, t0, M_effective, outdir, gcov, h2)
